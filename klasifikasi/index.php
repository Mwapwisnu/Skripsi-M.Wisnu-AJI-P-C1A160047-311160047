		...
		<div class="col-md-12">
			<div class="card ">
				<div class="card-header">
					<h4 class="card-title"> Table Data Klasifikasi</h4>
				</div>
									...
									<tbody>
										<?php foreach ($data as $td) : ?>
											<tr>
												...
												<td><?php if ($td['klasifikasi'] == ("Dewasa") || $td['klasifikasi'] == ("Orang Tua") || $td['klasifikasi'] == ("OrangTua")) {
															echo '4 Kategori';
														} else if ($td['klasifikasi'] == "Remaja") {
															echo '2 Kategori';
														} else {
															echo '1 Kategori';
														} ?>
												...
												<td class='text-center'>
													<form method='POST' action='edit.php' class='d-inline'>
														<input type='hidden' name='id_klasifikasi' value='<?= $td['id_klasifikasi']; ?>'>

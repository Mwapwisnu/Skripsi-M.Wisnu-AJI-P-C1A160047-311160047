...
$data = GetCatatanKepolisian();
foreach ($data as $td) :

  if ($id_catatan_kepolisian == $td['id_catatan_kepolisian']) {
    $html .=
  ...
  <br>
  <h4 style="text-align:center; font-weight: bold; text-decoration: underline; margin-top: -5px;">SURAT PENGANTAR CATATAN KEPOLISIAN</h4>
...
foreach ($data as $td) :
  if ($id_catatan_kepolisian == $td['id_catatan_kepolisian']) {
    ...
    $html .=
      ...
      '</table>
  <br>
  Berdasarkan keterangan RT/RW setempat dan sepengetahuan kami selama menjadi warga desa SUKAMUKTI yang bersangkutan :
  <br><br>
  BERKELAKUAN BAIK
  <br><br>
  Surat Keterangan ini dipergunakan untuk : 
  <h4 style="font-weight: bold; text-align:center;">MELAMAR PEKERJAAN</h4>
  <p>Demikian keterangan ini, untuk dipergunakan sebagaimana mestinya.
  <br><br>
  <div style="position:absolute; margin-bottom:30px; bottom:95; right:53px; text-align:center">
    ...
    <br><br><br><br><br>
    <small style="font-size: 1.1em; margin-top:3px; text-decoration: underline; text-align:center;">' . $td['nama_tertanda'] . '</small><br>
    </div>
    <div class="ttd">
      <img src="../assets/img/ttd/' . $td['ttd'] . '" style="width:200px;
      height:140px; margin-left:20px; margin-top:17px;">
    </div>
  </body>
</html>';
  }

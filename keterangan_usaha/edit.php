...
$datas = GetById($id_keterangan_usaha);
$dataAgama = GetAgama();
?>
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h5 class="title">Form Edit Surat Keterangan Usaha</h5>
				</div>
				<div class="card-body">
					<form action='function.php' method='post' enctype="multipart/form-data">
						<input type='hidden' name='id_keterangan_usaha' value="<?php echo $_POST['id_keterangan_usaha']; ?>">
						<?php
								...
								<div class="col-md-6 pr-md-1">
									...
									<?php if ($level == "Masyarakat") { ?>
										...
										<div class="form-group">
											...
											<input type='text' name='nama_usaha' class="form-control mt-2" value="<?= $data['nama_usaha']; ?>">
										</div>
										<div class="form-group">
											<label>Keperluan / Bidang</label>
											<input type='text' name='bidang' class="form-control mt-2" value="<?= $data['bidang']; ?>">
										</div>
									<?php } ?>
								</div>
							</div>

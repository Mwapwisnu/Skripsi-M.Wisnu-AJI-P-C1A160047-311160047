		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-header">
					<h5 class="title">Form Input Surat Keterangan Usaha</h5>
				</div>
				<div class="card-body">
						...
						<div class="row">
							<div class="col-md-6 pr-md-1">
								...
								<div class="form-group">
									...
									<input type='text' name='nama_usaha' class="form-control mt-2" placeholder="Contoh : JUAL BELI LIMBAH PABRIK">
								</div>
								<div class="form-group">
									<label>Keperluan / Bidang</label>
									<input type='text' name='bidang' class="form-control mt-2" placeholder="Contoh : PERBANKAN">
								</div>
							</div>
						</div>
				</div>
